    ...
    return (
        <div className={styles.container}>
            ...
            <div className="flex justify-between w-11/12 m-auto pb-1 pt-2">
                <div>
                    <p className="text-sm mb-1">Remaining Days to my Trip</p>
                ...
                <div className="flex text-xs sm:text-sm items-center py-5">
                    ...
                    <div className="flex items-center">
                        <div className="border border-right opacity-50 h-5 mx-2 sm:mx-4"></div>
                    ...
                    <div className='flex justify-center items-center flex-col max-w-md'>
                        <div className="flex pt-16 w-full justify-between">
                            <div className="rounded-full w-20 flex items-center justify-center bg-white pl-2">
                                <Image src={`/logo.png`} placeholder="blur" alt={'logo'} width="64" height="64" className="rounded-full" />
                            </div>
                            <div className="text-center border border-white max-w-max h-20">
                                ...
                                <h2 className="bg-white flex justify-center items-center text-black px-2 text-base sm:text-xl h-8">POWERED BY TRAVEL JINNI</h2>
                            </div>
                        </div>
                        <div className="max-w-full  text-center border-white border mt-2 pt-8 px-4 bg-gray-400 bg-opacity-10 blur-filter rounded-md">
                            <h1 className="text-3xl sm:text-5xl font-serif font-bold pb-5 px-4">Your Trip Awaits You!</h1>
